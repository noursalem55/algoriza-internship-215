...
namespace Vezeeta.Repo.Migrations
{
    ...
    [Migration("20231210155821_intialDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vezeeta.Core.Entities.Clinic", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vezeeta.Core.Entities.Booking", b =>
                {
                    b.HasOne("Vezeeta.Core.Entities.DoctorAppointment", null)
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("Vezeeta.Core.Entities.DoctorAppointment", b =>
                {
                    b.HasOne("Vezeeta.Core.Entities.Clinic", "Clinic")
